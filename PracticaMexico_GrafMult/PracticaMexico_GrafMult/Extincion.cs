...
{
    public partial class formExtincion : Form
    {
        formDetalles detalles = new formDetalles();

        public formExtincion()
        {
            InitializeComponent();
        }
        ...
        private void formExtincion_Load(object sender, EventArgs e)
        {
            detalles.categoria = "Peligro de Extincion";
        }
    }
}
